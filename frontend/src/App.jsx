...
function App() {
    ...
    useEffect(() => {
        ...
        if (amsToken && ssoAutoLogin) {
            ...
            // Store the AMS token in both sessionStorage (tab-specific) and localStorage (persistence)
            sessionStorage.setItem('ams_token', amsToken);
            sessionStorage.setItem('token', amsToken);
            localStorage.setItem('ams_token', amsToken);
            localStorage.setItem('token', amsToken);
