                                ...
                                {Object.entries(ACTION_META).map(([key, meta]) => {
                                    ...
                                    return (
                                        <li key={key}>
                                            ...
                                            >
                                                <span className="baa-action-item__icon">
                                                    <Icon fontSize="small" />
                                                </span>
                                                <span className="baa-action-item__label">{meta.shortLabel}</span>
                                                <span className="baa-action-item__count">{count}</span>
                        ...
                        {!loadingPreview && selectedAction && selectedPreview && (
                            <div className="baa-confirm">
                                ...
                                <div className="baa-confirm__impact">
                                    ...
                                    <span className="baa-confirm__impact-value">
                                ...
                                <div className="baa-confirm__actions">
                                    <button
                                        type="button"
                                        className="baa-btn baa-btn--primary"
