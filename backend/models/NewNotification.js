...
const newNotificationSchema = new mongoose.Schema({
    ...
    category: { type: String, enum: ['attendance', 'leave', 'break', 'system', 'admin', 'request', 'hr_query'], default: 'system' },
